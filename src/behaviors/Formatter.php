...
use wzzwx\yii2common\assets\DiffAsset;
use wzzwx\yii2common\forms\DiffFieldsForm;
use wzzwx\yii2common\helpers\ArrayHelper;
 ...
 *      'formatter' => [
 *           'as customFormatter' => 'wzzwx\yii2common\behaviors\Formatter',
 *       ],
 * pre-1: 注册一下DiffAsset // wzzwx\yii2common\assets\DiffAsset::register($this);
...
class Formatter extends Behavior
{
    /**
     * 展示两个不同字段的变化的html
     * NOTE: 使用时候必须引入 DiffAsset // wzzwx\yii2common\assets\DiffAsset::register($this);
     * @see DiffAsset
